...
description: Create polished presentation workflows with a three-step strategy: outline first, visual preview and aesthetic reference learning second, editable PPT production third. Use when building or revising slide decks from briefs, evidence images, reference images, AI-generated backgrounds, or when the user asks for a higher-end visual direction instead of a plain template.
---
...
2. Explore visual directions through references, previews, and generated backgrounds.
3. Build an editable PowerPoint deck with real text, diagrams, images, and notes.
...
- generate 3 visually distinct directions
...
- frames and translucent text carriers
- evidence photos
